...
# Timestamp: 2022/12/29 23:15:31 UTC
#
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "mkdir -p /home/neuro/bidsMReye/models" \
    \n    ], \
    \n    [ \
    \n      "workdir", \
    ...
    \n    [ \
    \n      "run", \
    \n      "wget -q https://osf.io/download/23t5v/ -O models/dataset_1to5.h5" \
    \n    ], \
    \n    [ \
    \n      "run", \
    \n      "wget -q https://osf.io/download/mr87v/ -O models/dataset_1to6.h5" \
    \n    ], \
    \n    [ \
    \n      "miniconda", \
    \n      { \
